...
import { IMarketplaces, Marketplaces } from 'app/shared/model/marketplaces.model';
...
describe('Service Tests', () => {
    describe('Marketplaces Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Marketplaces', async () => {
            ...
            it('should update a Marketplaces', async () => {
                const returnedFromService = Object.assign(
                    {
                        marketplace: 'BBBBBB',
            ...
            it('should delete a Marketplaces', async () => {
